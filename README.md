...
- 作画工具包括画笔、橡皮擦、填充、RGB 调色盘、左右键独立颜色、中键吸管和五名角色印花；按住 `E` 临时切换到橡皮擦，松开回到画笔，鼠标滚轮可以调整画笔、橡皮擦或印花大小。
...
- 作画工具包括左右键独立画笔颜色、橡皮擦、填充、RGB 调色盘、中键吸管和五名角色印花；按住 `E` 临时切换到橡皮擦，松开回到画笔，鼠标滚轮可以调整画笔、橡皮擦或印花大小。
...
- Tools include independent left- and right-button colors, an eraser, fill, an RGB color picker, a middle-click eyedropper, and five character stamps. Hold `E` to use the eraser temporarily and release it to return to the brush; the mouse wheel adjusts brush, eraser, or stamp size.
