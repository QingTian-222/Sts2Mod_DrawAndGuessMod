...
internal static class DrawAndGuessAssets
{
    ...
    public const string NeowSettingsIconPath =
        "res://images/ui/neow_settings_icon.png";
    ...
    public static void Install()
    {
        ...
        _neowSettingsIcon = LoadPackedImage(NeowSettingsIconPath);
    }

    private static Texture2D? LoadPackedImage(string path)
    {
